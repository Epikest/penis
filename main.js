			...
			return ba(
				(function (e, a, s) {
					return (
						...
						function () {
							for (
								var t = arguments, o = -1, n = ha(t.length - a, 0), r = Array(n);
								++o < n;
									...
									if (i || l)
										Va({
											...
											isStreak:
												...
												1 ===
													Na(new Date(this.lastCompletedTs), new Date()),
								...
								if (this.gameStatus === Za && this.canInput) {
									if (5 !== this.tileIndex)
										return (
											...
											void this.addToast("Penis too short")
										)
									this.evaluateRow()
								}
							}
								...
								this.$game.addEventListener("game-key-press", function (a) {
									...
									this.$game.addEventListener(
										...
										function (a) {
											...
											var s =
												e.$board.querySelectorAll("game-row")[
													e.rowIndex - 1
												]
											;(
												a.path ||
